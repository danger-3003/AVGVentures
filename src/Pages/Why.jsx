                ...
                <div className="flex items-center justify-center flex-col">
                    ...
                    <div className="flex items-start justify-center flex-wrap gap-5 lg:w-[50rem]">
                        <div className="flex items-center justify-center text-center flex-col w-[12rem] lg:w-[15rem] mb-5 mb:mb-10">
                            <p className="bg-gradient-to-br from-[#fff] via-secondary to-[#edc967] bg-clip-text text-transparent font-light font-[Limelight] text-2xl md:text-3xl">01</p>
                        ...
                        <div className="flex items-center justify-center text-center flex-col w-[12rem] lg:w-[15rem] mb-5 mb:mb-10">
                            <p className="bg-gradient-to-br from-[#fff] via-secondary to-[#edc967] bg-clip-text text-transparent font-light font-[Limelight] text-2xl md:text-3xl">02</p>
                        ...
                        <div className="flex items-center justify-center text-center flex-col w-[12rem] lg:w-[15rem] mb-5 mb:mb-10">
                            <p className="bg-gradient-to-br from-[#fff] via-secondary to-[#edc967] bg-clip-text text-transparent font-light font-[Limelight] text-2xl md:text-3xl">03</p>
                        ...
                        <div className="flex items-center justify-center text-center flex-col w-[12rem] lg:w-[15rem] mb-5 mb:mb-10">
                            <p className="bg-gradient-to-br from-[#fff] via-secondary to-[#edc967] bg-clip-text text-transparent font-light font-[Limelight] text-2xl md:text-3xl">04</p>
                        ...
                        <div className="flex items-center justify-center text-center flex-col w-[12rem] lg:w-[15rem] mb-5 mb:mb-10">
                            <p className="bg-gradient-to-br from-[#fff] via-secondary to-[#edc967] bg-clip-text text-transparent font-light font-[Limelight] text-2xl md:text-3xl">05</p>
                        ...
                        <div className="flex items-center justify-center text-center flex-col w-[12rem] lg:w-[15rem] mb-5 mb:mb-10">
                            <p className="bg-gradient-to-br from-[#fff] via-secondary to-[#edc967] bg-clip-text text-transparent font-light font-[Limelight] text-2xl md:text-3xl">06</p>
