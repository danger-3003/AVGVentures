...
function Home() {
    ...
    return (
        <div
            ...
            style={{background:`linear-gradient(to bottom,rgba(0,0,0,0.9),rgba(0,0,0,0.3)), url(${Bg})`, backgroundSize:"cover",backgroundPosition:"center",backgroundAttachment:"fixed"}}
        >
            <div className="text-secondary flex items-center justify-center flex-col py-32">
                ...
                >
                    ...
                    <p className="text-center w-full relative z-[3] group-hover:text-primary duration-500 font-semibold">Explore</p>
                    <div className="w-full bg-secondary h-10 rounded-full absolute z-[1] -left-[75%] group-hover:left-0 duration-500">
